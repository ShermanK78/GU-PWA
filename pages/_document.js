    ...
    return (
      <Html>
        ...
        <body>
          ...
          {/* Modal HTML */}
          <div id="installModal" style={{ display: 'none', position: 'fixed', bottom: '0', left: '0', width: '100%',backgroundColor: "red", borderColor: "darkblue", color: "white", alignContent: "center", padding: "30px", opacity: 0.75  }}>
            <div>
